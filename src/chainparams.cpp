...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("00000d7bb77efb8ef41961cff3b36b0bfafbaebe2fc0bd11e0068c4d6141c76d")); 
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1534291200, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vTreasuryRewardAddress="QC9VGUdfbtfavpuutd6RLUh2PFUcx7Smb5";//???
        strNetworkID = "main";
        /**
        ...
        nDefaultPort = 35912;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Quadrivae starting difficulty is 1 / 2^12
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "15 Aug 2018, Confusion continues as immigrant children remain separated from parents";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1534291200;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1459312;       
...
*/              
        ...
        assert(hashGenesisBlock == uint256("00000d7bb77efb8ef41961cff3b36b0bfafbaebe2fc0bd11e0068c4d6141c76d"));
        assert(genesis.hashMerkleRoot == uint256("a7b82e7501395f8276be2425eb3a8a9950645cc2f3a2a72c478c594a3ce7e31d"));

	vSeeds.push_back(CDNSSeedData("seednode1", "207.148.17.35"));         
        vSeeds.push_back(CDNSSeedData("seednode2", "149.28.124.191")); 
	vSeeds.push_back(CDNSSeedData("seednode3", "149.28.241.251"));
	vSeeds.push_back(CDNSSeedData("seednode4", "45.32.214.113"));
        ...
        strObfuscationPoolDummyAddress = "QC9VGUdfbtfavpuutd6RLUh2PFUcx7Smb5";//???
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Quadrivae: 1 day
        nTargetSpacing = 1 * 60;  // Quadrivae: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        genesis.nTime = 1534291200;  // Thursday, May 3, 2018 11:00:00 AM
        genesis.nBits = 0x1e0ffff0;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("testnet.quadrivae.io", "testnet.quadrivae.io"));         // Single node address
        //vSeeds.push_back(CDNSSeedData("testnet1.quadrivae.io", "testnet1.quadrivae.io"));       // Single node address
        //vSeeds.push_back(CDNSSeedData("testnet2.quadrivae.io", "testnet2.quadrivae.io"));       // Single node address
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Quadrivae: 1 day
        nTargetSpacing = 1 * 60;        // Quadrivae: 1 minutes
