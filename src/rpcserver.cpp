...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Quadrivae server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Quadrivae server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Quadrivae features */
        {"quadrivae", "masternode", &masternode, true, true, false},
        {"quadrivae", "listmasternodes", &listmasternodes, true, true, false},
        {"quadrivae", "getmasternodecount", &getmasternodecount, true, true, false},
        {"quadrivae", "masternodeconnect", &masternodeconnect, true, true, false},
        {"quadrivae", "masternodecurrent", &masternodecurrent, true, true, false},
        {"quadrivae", "masternodedebug", &masternodedebug, true, true, false},
        {"quadrivae", "startmasternode", &startmasternode, true, true, false},
        {"quadrivae", "createmasternodekey", &createmasternodekey, true, true, false},
        {"quadrivae", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"quadrivae", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"quadrivae", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"quadrivae", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"quadrivae", "getmasternodescores", &getmasternodescores, true, true, false},
        {"quadrivae", "mnbudget", &mnbudget, true, true, false},
        {"quadrivae", "preparebudget", &preparebudget, true, true, false},
        {"quadrivae", "submitbudget", &submitbudget, true, true, false},
        {"quadrivae", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"quadrivae", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"quadrivae", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"quadrivae", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"quadrivae", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"quadrivae", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"quadrivae", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"quadrivae", "checkbudgets", &checkbudgets, true, true, false},
        {"quadrivae", "mnsync", &mnsync, true, true, false},
        {"quadrivae", "spork", &spork, true, true, false},
        {"quadrivae", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"quadrivae", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use quadrivaed, or the -server option to quadrivae-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> quadrivae-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:35911/\n";
}
